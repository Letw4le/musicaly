<div id=center_menu>
    <div id="menu">
        <div id="logo_menu">
            <div class="symb_menu"></div>
            musicaly
        </div>
        
        <nav id="onglets">
            <a id="txt_home" class="onglet-link" href="index.php?page=home"> Accueil </a>
            <a id="txt_research" class="onglet-link" href="index.php?page=research"> Rechercher </a>
            <a id="txt_historic" class="onglet-link" href="index.php?page=historic"> Historique </a>
            <span id="onglet-utilisateur">
                <a id="txt_login" class="onglet-link" href="index.php?page=login"> Se connecter </a>
...
<script>
    const userConnected = <?php echo json_encode($_SESSION['user'] ?? null); ?>;
</script>